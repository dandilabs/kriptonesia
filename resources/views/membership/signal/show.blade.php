                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <span
                                    class="badge badge-{{ in_array($signal_trade->type, ['buy', 'strong_buy']) ? 'success' : 'danger' }}">
                        ...
                        <div class="card-body">
                            <div class="row mb-4">
                                <div class="col-md-4">
                                    <h5><i class="fas fa-exchange-alt"></i> Trade Type</h5>
                                    <p>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <p>${{ number_format($signal_trade->entry_price, 2) }}</p>
                                </div>
                            </div>
                            ...
                            <div class="row mb-4">
                                <div class="col-md-4">
                                    ...
                                    <p class="text-success">${{ number_format($signal_trade->target_price, 2) }}</p>
                                </div>
                                <div class="col-md-4">
                                    <h5><i class="fas fa-shield-alt"></i> Stop Loss</h5>
                                    <p class="text-danger">${{ number_format($signal_trade->stop_loss, 2) }}</p>
                                </div>
                                <div class="col-md-4">
                                    <h5><i class="fas fa-hourglass-end"></i> Expires</h5>
                                    <p>
                                        @if ($signal_trade->expired_at)
                                            {{ $signal_trade->expired_at->diffForHumans() }}
                                        @else
                                ...
                                <div class="info-box-content">
                                    ...
                                    <span class="info-box-number">
                                        @php
                                            ...
                                            echo $risk > 0 ? number_format($reward / $risk, 2) : 'N/A';
                                        @endphp
                                    </span>
                                </div>
                            </div>
