...
@endif
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">List Trashed</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{route('post.index')}}">Back</a></li>
                        <li class="breadcrumb-item active">List Trashed</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                                        ...
                                        <tr>
                                            ...
                                            <td class="project-actions text-center">
                                                <form action="{{route('post.delete', $item->id)}}" method="post">
                                                    @csrf
                                                    @method('delete')
                                                    <a href="{{route('post.restore', $item->id)}}" class="btn btn-outline-info btn-sm"> <i class="fas fa-pencil-alt">
                                                    </i> Restore</a>
